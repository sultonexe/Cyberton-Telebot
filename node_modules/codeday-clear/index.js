...
module.exports = function(token, secret){
  // DOESN'T PLAY NICE WITH S5 MODULE
  var CLEAR_API_BASE = "https://clear.codeday.org/api/";
  ...
  var get = function(endpoint, params, callback){
    ...
    unirest.get(CLEAR_API_BASE + endpoint)
    .query(params)
    .end(function(res) {
      if (res.error) {
        console.log("Clear err", res.error);
        callback({debug_info: {API_BASE: this.API_BASE}});
      } else {
